...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Produccions Contrabaix - Noticies</title>
    ...
    <section class="noticies">
        ...
        <div class="module">
            <h1> Properament a la venda el nou CD Marc Miralta Flamenco Reunion!</h1>
            <img src="img/flamencoreunionweb.jpg" alt="">
            <p>Aviat a les botigues el nou disc <strong>Marc Miralta Flamenco Reunion</strong>, nova producció del segell ContraBaix distribuït per Karonte. Una banda liderada per Marc Miralta i acompanyat de Baptiste Trotignon al piano, Perico Sambeat al saxo, Blas Córdoba al cante, Javier Colina al contrabaix i David Domínguez al “cajón” i percussions; que torna a les arrels del clàssic i reconegut New York Flamenco Reunion, un disc de capçalera entre aficionats al jazz-flamenco.</p>
